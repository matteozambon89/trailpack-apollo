 ...
 * @Last modified time: 2018-03-04 05:32:28
 */
...
module.exports = {
  /**
   * Given app and schema create the available routes for Express
  ...
  /**
   * Given app and schema create the GraphQL routes for Express
   * @param  {object} app    TrailsJs App
   * @param  {object} schema Apollo Schema
  ...
  createRouteGraphql(app, schema) {
    ...
    return {
      ...
      handler: graphqlExpress(handlerOpts)
    }
  },
  /**
   * Given app create the GraphiQL route for Express
   * @param  {object} app TrailsJs App
   * @return {object}     Computed Route
   */
  createRouteGraphiql(app) {
    ...
    return {
      ...
      handler: graphiqlExpress(handlerOpts)
    }
  }
}
